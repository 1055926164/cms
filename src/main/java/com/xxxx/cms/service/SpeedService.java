...
public class SpeedService extends BaseService<Speed,Integer> {
    ...
    public void check(Speed speed) {
        ...
        AssertUtil.isTrue(speed.getCodeSpStart()>speed.getCodeSpEnd(),"代码进度起始不能大于代码进度结束");
        AssertUtil.isTrue(speed.getVideoSpStart()>speed.getVideoSpEnd(),"视频进度起始不能大于视频进度结束");
    }
}
