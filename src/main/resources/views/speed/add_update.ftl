...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item layui-row layui-col-xs12">
        <div class="layui-col-xs4">
            ...
            <div class="layui-input-block"  style="width: 80px">
                <input type="text" oninput="value=value.replace(/[^\d]/g,'')"  class="layui-input"
                       lay-verify="required" name="videoSpStart" id="videoSpStart" placeholder="开始数字"  value="<#if (speed.videoSpStart)??>${(speed.videoSpStart)?c}</#if>">
            </div>
        </div>
        <div class="layui-col-xs4">
            ...
            <div class="layui-input-block" style="margin-left: 70px;width: 80px;">
                <input type="text" oninput="value=value.replace(/[^\d]/g,'')"  class="layui-input"
                       lay-verify="required" name="videoSpEnd" id="videoSpEnd" placeholder="结束数字" value="<#if (speed.videoSpEnd)??>${(speed.videoSpEnd)?c}</#if>">
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item layui-row layui-col-xs12">
        <div class="layui-col-xs4">
            ...
            <div class="layui-input-block"  style="width: 80px">
                <input type="text" oninput="value=value.replace(/[^\d]/g,'')"  class="layui-input"
                       lay-verify="required" name="codeSpStart" id="codeSpStart" placeholder="开始数字"  value="<#if (speed.codeSpStart)??>${(speed.codeSpStart)?c}</#if>">
            </div>
        </div>
        <div class="layui-col-xs4">
            <label style="float: left;
            ...
            <div class="layui-input-block" style="margin-left: 70px;width:80px;">
                <input type="text" oninput="value=value.replace(/[^\d]/g,'')" class="layui-input"
                       lay-verify="required" name="codeSpEnd" id="codeSpEnd" placeholder="结束数字" value="<#if (speed.codeSpEnd)??>${(speed.codeSpEnd)?c}</#if>">
            </div>
        </div>
    </div>
