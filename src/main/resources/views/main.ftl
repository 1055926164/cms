                    ...
                    <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                  <#--  <dd>
                                    ...
                                    <dd>
                                        <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-1" data-tab="bug/index" target="_self"><i class="fa fa-book"></i><span class="layui-left-nav"> bug集锦</span></a>
                                    </dd>
                                    <dd>
                                        <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-2" data-tab="brush/index" target="_self"><i class="fa fa-thumbs-o-up"></i><span class="layui-left-nav"> 快乐刷题</span></a>
                                    </dd>
                                    <dd>
